...
<!-- PROGRESS:BADGE -->
![matched](https://img.shields.io/badge/matched-366%2F907%20(40.35%25)-1f6feb)
<!-- /PROGRESS:BADGE -->
...
|---|---:|---:|---|
| **Main executable** (`SLUS_011.93`) | 907 | 366 | `▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱` 40.35% |
| &nbsp;&nbsp;└ `src/main/156C.c` (text unit) | 907 | 366 | `▰▰▰▰▰▰▰▰▱▱▱▱▱▱▱▱▱▱▱▱` 40.35% |
<!-- /PROGRESS:TABLE -->
